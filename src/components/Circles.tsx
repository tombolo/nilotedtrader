...
const CircleDesign: React.FC = () => {
  ...
  return (
    <div
      className="bg-[#0E0E2C] flex flex-col rounded-xl items-center justify-center w-full z-50 m-2 p-4"
      style={{
        boxShadow: `
    ...
    >
      <div
        className="bg-[#15153B] rounded-xl flex items-center justify-center p-4 sm:p-8 w-full z-50"
        style={{
          boxShadow: `
